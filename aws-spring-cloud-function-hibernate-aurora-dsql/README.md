# Example of Lambda with managed Java 25 runtime using Spring Boot 4 with AWS Spring Cloud Function, Hibernate as an ORM framework, Hikari Connection Pool and Amazon Aurora DSQL database 


## Architecture

<p align="center">
  <img src="/aws-spring-cloud-function-hibernate-aurora-dsql/src/main/resources/img/app_arch.png" alt="Application Architecture"/>
</p>
...
## Switch to the aws-spring-cloud-function-hibernate-aurora-dsql directory  
