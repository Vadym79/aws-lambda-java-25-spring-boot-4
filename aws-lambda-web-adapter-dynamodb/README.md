# Example of Lambda with managed Java 25 runtime using Spring Boot 4 with AWS Lambda Web Adapter and Amazon DynamoDB  


## Architecture

<p align="center">
  <img src="/aws-lambda-web-adapter-dynamodb/src/main/resources/img/app_arch.png" alt="Application Architecture"/>
</p>
...
## Switch to aws-lambda-web-adapter-dynamodb directory   
