# Example of Lambda with Custom Runtime based on GraalVM Native Image with Java 25 using Spring Boot 4 with AWS Spring Cloud Function and Amazon DynamoDB database  


## Architecture

<p align="center">
  <img src="/aws-spring-cloud-function-as-graalvm-native-image/src/main/resources/img/app_arch.png" alt="Application Architecture"/>
</p>
...
## Switch to aws-spring-cloud-function-dynamodb-as-graalvm-native-image directory  
