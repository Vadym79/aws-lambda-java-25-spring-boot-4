# Example of Lambda with Custom Runtime based on GraalVM Native Image with Java 25 using Spring Boot 4 with AWS Serverless Java Container, Spring JDBC, Hikari Connection Pool and Amazon Aurora DSQL database as GraalVM Native Image  


## Architecture

<p align="center">
  <img src="/aws-spring-cloud-function-spring-jdbc-aurora-dsql-as-graalvm-native-image/src/main/resources/img/app_arch.png" alt="Application Architecture"/>
</p>
...
## Switch to aws-spring-cloud-function-spring-jdbc-aurora-dsql-as-graalvm-native-image directory   
